 ...
 */
final class Version20240618093443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE options CHANGE value value JSON NOT NULL COMMENT \'(DC2Type:json_unescaped)\'');
        $this->addSql('ALTER TABLE real_time_commodity ADD ch DOUBLE PRECISION NOT NULL, ADD chp DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE real_time_commodity DROP ch, DROP chp');
    }
}
