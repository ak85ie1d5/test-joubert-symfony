 ...
 */
final class Version20240614080237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE real_time_commodity ADD price_gram24k DOUBLE PRECISION NOT NULL, ADD price_gram22k DOUBLE PRECISION NOT NULL, ADD price_gram21k DOUBLE PRECISION NOT NULL, ADD price_gram20k DOUBLE PRECISION NOT NULL, ADD price_gram18k DOUBLE PRECISION NOT NULL, ADD price_gram16k DOUBLE PRECISION NOT NULL, ADD price_gram14k DOUBLE PRECISION NOT NULL, ADD price_gram10k DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE real_time_commodity DROP price_gram24k, DROP price_gram22k, DROP price_gram21k, DROP price_gram20k, DROP price_gram18k, DROP price_gram16k, DROP price_gram14k, DROP price_gram10k');
    }
}
